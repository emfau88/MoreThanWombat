...
const ANIMATIONS: AnimationSpec[] = [
  ...
  // The action rates span their gameplay timelines, so the last pose does not
  // freeze during recovery. Walk stays deliberately readable at reduced Gym speed.
  { key: 'mara-breach-walk', textureKey: 'mara-breach', frames: [4, 5, 6, 7], frameRate: 6, repeat: -1 },
  { key: 'mara-breach-gate-kick', textureKey: 'mara-breach', frames: [8, 9, 10, 11], frameRate: 11, repeat: 0 },
  { key: 'mara-breach-step', textureKey: 'mara-breach', frames: [12, 13, 14, 13], frameRate: 7, repeat: 0 },
  ...
  { key: 'mara-breach-red-line-barrage', textureKey: 'mara-breach', frames: [24, 25, 26, 27], frameRate: 5, repeat: 0 },
