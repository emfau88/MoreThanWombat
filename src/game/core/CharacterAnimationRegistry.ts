...
const ANIMATIONS: AnimationSpec[] = [
  ...
  { key: 'wombat-jab', textureKey: 'wombat', frames: { start: 8, end: 11 }, frameRate: 14, repeat: 0 },
  { key: 'wombat-belly-slam', textureKey: 'wombat', frames: { start: 12, end: 15 }, frameRate: 10, repeat: 0 },
  ...
  { key: 'wombat-air-bonk', textureKey: 'wombat-air-bonk', frames: { start: 0, end: 2 }, frameRate: 12, repeat: 0 },
  { key: 'wombat-earthshaker-fx', textureKey: 'wombat-earthshaker-fx', frames: { start: 0, end: 3 }, frameRate: 9, repeat: 0 },
  ...
  { key: 'discount-wizard-fx-fireball', textureKey: 'discount-wizard-fx', frames: { start: 0, end: 3 }, frameRate: 14, repeat: 0 },
  { key: 'discount-wizard-fx-hit-puff', textureKey: 'discount-wizard-fx', frames: { start: 4, end: 7 }, frameRate: 14, repeat: 0 },
  { key: 'discount-wizard-fx-miscast', textureKey: 'discount-wizard-fx', frames: { start: 8, end: 11 }, frameRate: 12, repeat: 0 },
  { key: 'discount-wizard-ultimate-teleport', textureKey: 'discount-wizard-ultimate-fx', frames: { start: 0, end: 3 }, frameRate: 14, repeat: 0 },
  { key: 'discount-wizard-ultimate-orb', textureKey: 'discount-wizard-ultimate-fx', frames: { start: 4, end: 7 }, frameRate: 12, repeat: -1 },
  { key: 'discount-wizard-ultimate-impact', textureKey: 'discount-wizard-ultimate-fx', frames: { start: 8, end: 11 }, frameRate: 14, repeat: 0 },
