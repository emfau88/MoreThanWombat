...
const ANIMATIONS: AnimationSpec[] = [
  ...
  { key: 'budget-barbarian-dead', textureKey: 'budget-barbarian', frames: { start: 16, end: 19 }, frameRate: 5, repeat: 0 },
  { key: 'budget-barbarian-jump', textureKey: 'budget-barbarian', frames: [0], frameRate: 8, repeat: 0 },
  { key: 'budget-barbarian-fall', textureKey: 'budget-barbarian', frames: [0], frameRate: 8, repeat: 0 },
  { key: 'budget-barbarian-landing', textureKey: 'budget-barbarian', frames: [0], frameRate: 8, repeat: 0 },
  { key: 'budget-barbarian-air-bonk', textureKey: 'budget-barbarian', frames: [8, 9, 11], frameRate: 12, repeat: 0 },
  { key: 'mara-breach-idle', textureKey: 'mara-breach', frames: { start: 0, end: 3 }, frameRate: 5, repeat: -1 },
  // Six distinct contact, passing and recoil poses form one complete gait.
  { key: 'mara-breach-walk', textureKey: 'mara-breach-walk', frames: { start: 0, end: 5 }, frameRate: 10, repeat: -1 },
  ...
  // The tucked-knee frame keeps Mara readable in both rising and falling
  // phases. Frame 21 is a long reclined transition pose and made ordinary
  // jumps look like an unintended backwards fall.
  { key: 'mara-breach-fall', textureKey: 'mara-breach', frames: [20], frameRate: 8, repeat: 0 },
  { key: 'mara-breach-air-kick', textureKey: 'mara-breach', frames: [20, 22, 20], frameRate: 13, repeat: 0 },
