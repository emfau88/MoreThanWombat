...
export const SHIPPABLE_PLAYER_FIGHTERS = ['wombat', 'discount_wizard', 'budget_barbarian', 'mara_breach'] as const satisfies readonly FighterId[];
export const SHIPPABLE_DUEL_ENEMIES = ['angry_pigeon', 'discount_wizard', 'budget_barbarian', 'mara_breach'] as const satisfies readonly FighterId[];
